 ...
 * stream.
 */
class PDF2XHTML extends PDFTextStripperByArea {
    ...
    public static void process(
        ...
        try {
            ...
            Rectangle2D region = new Rectangle2D.Double(70, 50, 490, 680);
            ...
            pdf2XHTML.addRegion(regionName, region);
            config.configure(pdf2XHTML);
            
            List<COSObjectable> pages=document.getDocumentCatalog().getAllPages();
            Iterator<COSObjectable> pageIter = pages.iterator();
            while (pageIter.hasNext()){
                PDPage nextPage = (PDPage)pageIter.next();
                pdf2XHTML.extractRegions(nextPage);
            }
